...
As of 2026-08-05, Cambridge and Jesus College affiliation status is subject to a dated public resignation statement and should not be presented as a current role without a newer institutional record. Cambridge separately announced an investigation into qualifications and honorary appointments; its canonical statement URL returned HTTP 200 again on 2026-08-09 with unchanged process wording, but the outcome remains unknown. [Cambridge statement recheck](../sources/2026-08-09-cambridge-investigation-statement-recheck.md)
