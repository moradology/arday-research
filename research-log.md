...
2026-08-09 — Southfields Academy school-record recheck: the official Alumni & School History page returned HTTP 200 and still contains no `Jason Arday` attendance, alumni, register, or examination record. It establishes that the institution was called Southfields Community College before becoming Southfields Academy in 2012, making the reported school-name transition coherent without proving attendance. The current HTML and response headers were preserved under `assets/captures/2026-08-09-southfields-academy-recheck/`; C-067 and SRC-160 were updated in place.
...
2026-08-09 — BBC *Best of Today* audio audit: sampled the preserved 2,509-second MP3 and located a likely Jason Arday contribution at source offsets 300–360 seconds. A corrected-mono `small.en` pass maps discussion of communication, active/critical listening, a likely “fourth R”/oracy formulation, and curriculum breadth. Added `SRC-1146/C-1415–C-1416`; the JSON remains navigation-only and the proper term/speaker boundary require human listening.

2026-08-09 — *Portrait of a Londoner* audio audit: sampled the locally preserved 39:19 MP3 at source offsets 1470–1950 seconds and created a corrected-mono `small.en` navigation derivative. Added `SRC-1147/C-1417–C-1420` for first-person passages on poverty, family/caregiving, autism and global developmental delay, delayed speech and Wandsworth schooling, Clapham, Sandro, music, speech therapy, and literacy support. These remain testimony; independent family, clinical, school, therapy, and relationship records remain open.

2026-08-09 — *Full Disclosure* audio audit: sampled the locally preserved 1:09:48 MP3 at source offsets 180–420 seconds and separated Arday’s guest responses from the host’s biography. Added `SRC-1148/C-1421–C-1423` for higher-education mission, separate autism/global-developmental-delay self-report, and non-speaking observation. The JSON is navigation-only; medical, employment, and outcome records remain open.

2026-08-09 — Surviving Society *Social Science for Social Justice?* audio audit: sampled the locally preserved 36:33 MP3 at source offsets 1440–1800 seconds and created a corrected-mono `small.en` navigation derivative. Added `SRC-1149/C-1424–C-1426` for Arday-attributed positions on academic-writing surveillance, agency, publishing access for Black academics, and accessible scholarship. Multi-speaker boundaries and project outcomes remain open.
...
Capture: the selected JSON extraction preserves the page metadata and bounded observations. The profile repeats the circulating speech, literacy, neurodivergence, Clapham, PE-teaching, Sandro Sandri, Black Curriculum, and decolonisation narrative, and links to already-known sources. It also contains visible source-version errors and malformed prose.
...
## 2026-08-09 — SRC-1134/C-1394: UnHerd thesis-critique commentary

Discovery: a citation from the current Wikipedia revision led to Richard Dawkins’s public UnHerd article, “Jason Arday: a question of academic standards,” dated 8 August 2026.

Capture: the article reports 332 plural-noun apostrophe errors in the thesis, including one in the title, and reproduces several passages for a prose-clarity critique. The public lead-image URL returned a cache-miss failure when followed; no image binary was recovered.

Decision: added SRC-1134/C-1394 as named commentary and an audit pointer. The reported count and passages remain to be checked against the thesis corpus; no plagiarism or fraud finding is inferred from the article.
...
## 2026-08-09 — SRC-1128/C-1388: Crossref/JSTOR book DOI reconciliation

Discovery: a fresh exact-name Crossref pass found one DOI not yet represented in the local DOI corpus: `10.2307/jj.26932075`.

Capture: the public Crossref work record identifies *We See Things They’ll Never See* as a 2025 Princeton University Press monograph by Chantelle Jessica Lewis and Jason Arday, with ISBNs `9780691263946` and `0691263949`, and declares an `is-identical-to` relation with `10.1515/9780691263946`.
