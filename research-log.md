...
| 2026-08-06 | MMU LEED keynote binary and caption preservation | MMUtube Kaltura page, public flavor-asset API, public 1080p MP4 flavor, English (British) caption asset, and thumbnail endpoint | Updated SRC-058/SRC-142; preserved an 847M MP4, 108,811-byte SRT, and 1920×1080 thumbnail with checksums. Kaltura reports 81% caption accuracy; extracted PE-teacher wording is retained as self-report, not employment verification | Continue with the next verified media lead; do not rerun MMU unless the page, flavor asset, or caption asset changes |
