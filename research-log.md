...
Decision: added C-947 as an archive-integrity observation. This closes the GitHub handoff gap for the complete webinar while retaining the parent MP4 hash as the integrity anchor. The derivative is not a transcript; automatic captions and speaker/role attribution remain unverified. Google Drive was not updated; GitHub remains the active publication target.

## 2026-08-08 — SRC-268/C-946: complete *Neurodivergent Show* audio derivative created

Archive action: transcoded the 175,067,296-byte parent MP4 to a complete 28,794,329-byte AAC `.m4a` derivative at 64 kb/s. The derivative runs 57:39.95 and passed an FFmpeg decode validation; its SHA-256 is `fee3389b06abac7daf476dfb79ce0b13f3cc49ff2ff36b41125e4267f950717d`.

Decision: added C-946 as an archive-integrity observation. This closes the GitHub handoff gap for the complete interview while retaining the parent MP4 hash as the integrity anchor. The derivative is not a transcript; automatic captions and the diagnosis, first-word, literacy, and Sandro passages remain unverified. Google Drive was not updated; GitHub remains the active publication target.
...
Decision: added C-890 as an archive-integrity observation. This closes the GitHub handoff gap for the complete interview while retaining the parent MP4 hash as the integrity anchor. The derivative is not a transcript and the existing automatic-caption windows remain unverified. Google Drive was not updated; GitHub remains the active publication target.
...
Decision: added C-943 as an archive-integrity observation. This closes the sidecar-context gap for the dated UCU public-output record; no transcript or substantive decolonisation claim was upgraded. Google Drive was not updated; GitHub remains the active publication target.
...
Archive action: created a 38,308,300-byte stream-copy review clip covering source interval 00:00–10:00 and verified its checksum. The parent MP4 hash remains the integrity anchor and the full parent remains local-only.

Decision: added C-935 as an archive-integrity observation. The clip improves audiovisual handoff for the dated public-output record; it is not a new event or verified transcript, and no substantive discussion claim was added. Google Drive was not updated; GitHub remains the active publication target.
...
Archive action: checksum-validated and committed the video-only MP4, audio M4A, automatic British-English captions, metadata, and thumbnail. Both streams decode cleanly but remain separate; local muxing was not retried.

Decision: added C-919 as an archive-integrity observation. The teaser remains distinct from the inaccessible full keynote, and its caption-derived first-person remarks remain pending human listening. Google Drive was not updated; GitHub remains the active publication target.
